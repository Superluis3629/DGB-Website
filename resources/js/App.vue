  ...
  <div>
    ...
    <div class="layout-wrapper layout-content-navbar ">
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" v-if="check_login">
          ...
          <div class="app-brand demo">
            <a href="index.htm" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text text-uppercase fw-bold ms-2">DGB</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            <li class="menu-item">
              <router-link to="/store" class="menu-link">
                ...
                <div data-i18n="Analytics">ສະຕ໊ອກສິນຄ້າ</div>
              </router-link>
            </li>
            <li class="menu-item">
              <router-link to="/pos" class="menu-link">
                <i class="menu-icon tf-icons bx bx-cart-add"></i>
                <div>ຂາຍ <span style="font-family: 'Semibold';">POS</span></div>
              </router-link>
            </li>
            <li class="menu-item">
            ...
            <li class="menu-item">
              <router-link to="/compliance" class="menu-link">
                <i class="menu-icon tf-icons bx bx-file"></i>
                <div>Ethical Clean Center</div>
              </router-link>
            </li>
          </ul>
        </aside>
        <div class="layout-page">
          <nav
            ...
            id="layout-navbar" v-if="check_login">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="assets/img/avatars/1-1.png" alt="" class="w-px-40 h-auto rounded-circle">
                    </div>
                  </a>
            ...
            <footer class="content-footer footer bg-footer-theme" v-if="check_login">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ©
                  , made with ❤️ by <a href="#" target="_blank" class="footer-link fw-bolder">DGB</a>
                </div>
                <div>
    ...
    <!-- <div class="buy-now" v-if="check_login">
